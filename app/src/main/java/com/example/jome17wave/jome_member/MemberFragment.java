...
//    actionBar = ((AppCompatActivity)activity).getActionBar();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       activity.setTitle(R.string.M_Title);
...
//                        Navigation.findNavController(view).navigate(R.id.action_memberFragment_to_friendListFragment);
//                        break;
//                    case R.id.clScore:
//                        Navigation.findNavController(view).navigate(R.id.action_memberFragment_to_scoreFragment);
//                        break;
//                    case R.id.clGroupRecord:
//                        Navigation.findNavController(view).navigate(R.id.action_memberFragment_to_groupRecordFragment);
//                        break;
//                    case R.id.clJoinRecord:
//                        Navigation.findNavController(view).navigate(R.id.action_memberFragment_to_joinRecordFragment);
//                        break;
//                    default:
//                        break;
//                }
